...
def main():
    ...
    It displays the interest earned on both the savings and CD accounts, then updates the balances.
    """
    # Prompt the user to set the savings balance, interest rate, and months for the savings account.
    savings_balance=float(input("Enter the Savings Balance: "))
    savings_interest=float(input("Enter the Savings Interest Rate, in %: "))
    savings_months=int(input("Enter the Savings period in months: "))
    ...
    print(f"Interest earned: \n${interest_earned:,.2f}")
    print(f"Updated Savings Balance: \n${updated_savings_balance:,.2f}")
    ...
    print(f"Interest earned: \n${interest_earned:,.2f}")
    print(f"Updated CD Balance {cd_months} months: \n${updated_cd_balance:,.2f}")
